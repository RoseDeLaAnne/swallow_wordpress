            ...
            <main class="main container">
                <div class="team">
                    <div class="team__item">
                        ...
                        <img class="news__item-image" src="<?php the_field('worker_image'); ?>" alt="">;
                            <h2 class="team__item-name"><?php the_field('worker_name'); ?></h2>
                            <h3 class="team__item-status">
                                <?php the_field('worker_status'); ?>
                            </h3>
                        </div>

                        <p class="team__item-description">
                            <?php the_field('worker_description'); ?>
                        </p>
                    </div>
                </div>
            </main>
