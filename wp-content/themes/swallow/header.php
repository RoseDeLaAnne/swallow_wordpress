<header id="header" class="header header_absolute">
      ...
      <ul class="nav__box-1">
        ...
        <li class="nav__item">
          ...
          <ul class="nav-dropdown">
            ...
            <li class="nav-dropdown__item">
              <a href="resource-groups" class="nav-dropdown__item-link">Ресурсные кружки "На равных"</a>
            </li>
            <li class="nav-dropdown__item">
            ...
            <li class="nav-dropdown__item">
              <a href="sos-help" class="nav-dropdown__item-link">Помощь в тяжелой жизненной ситуации</a>
            </li>
            <li class="nav-dropdown__item">
              <a href="consultation" class="nav-dropdown__item-link">Консультация специалистов</a>
            </li>
            <li class="nav-dropdown__item">
              <a href="to-future-parents" class="nav-dropdown__item-link">Будущим приёмным родителям</a>
            </li>
          </ul>
        </li>
        <li class="nav__item">
